...
2. **View each image** — read it (the agent is multimodal)
...
Save previews to `.slide-design/slide-previews/` (style-a.html, style-b.html, style-c.html). Each should be self-contained, ~50-100 lines, showing one animated title slide.
...
1. **Clean up** — Delete `.slide-design/slide-previews/` if it exists
