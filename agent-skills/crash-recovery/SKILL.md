...
Do not create a replacement tmux session or resume Codex unless the human user
explicitly asks. A rebooted local tmux server cannot restore its old processes
or pane buffers when no tmux-resurrect save exists.
