...
Lei. It owns spawning, decisions, canonical state, and final synthesis. Every
operational child is a leaf.
...
7. The coordinator owns final synthesis and every user-visible decision.
